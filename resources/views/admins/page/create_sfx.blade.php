...
$dir = '/'.implode('/',$dir).'/'.config('lfm.vol.sfx');
@endphp
@extends('layouts.app')
@section('title','SFX FOLDER')
@section('header_page','SFX Folder')
...
<script>
    $('#auth-role').on('change',function(e){
        if($(this).val() == 'SFX' || $(this).val() == 'Check'){
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                {{-- <form action="{{route('pages.storeSFX',['volume' => $volume->id])}}" method="POST"> --}}
                    <div class="card">
