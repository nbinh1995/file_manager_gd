...
$dir = '/'.implode('/',$dir).'/'.config('lfm.vol.type');
@endphp
@extends('layouts.app')
@section('title','TYPE FOLDER')
@section('header_page','Type Folder')
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                {{-- <form action="{{route('pages.storeType',['volume' => $volume->id])}}" method="POST"> --}}
                    <div class="card">
