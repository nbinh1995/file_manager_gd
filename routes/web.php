...
Route::group(['namespace' => 'App\Http\Controllers\Admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'file-manager','middleware' => 'admin'], function () {
        Route::get('/', 'FileManagerController@index')->name('file-manager.index');
        Route::get('put', function() {
            $truePath = '/files/1';
            $googlePath ='/';
            $contents = collect(Storage::cloud()->listContents('/', true))->where('type','dir')->map(function($item){
